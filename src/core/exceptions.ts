...
export class KasaTimeoutError extends KasaException {
  constructor(message?: string, options?: ErrorOptions) {
    super(message, options);
    this.name = "KasaTimeoutError";
  }
}

/** Connection exception for device errors. */
export class ConnectionError extends KasaException {
  constructor(message?: string, options?: ErrorOptions) {
    super(message, options);
...
export class UnsupportedDeviceError extends KasaException {
  ...
  constructor(
    message?: string,
    options?: { discoveryResult?: Record<string, unknown>; host?: string },
  ) {
    super(message);
...
export class DeviceError extends KasaException {
  ...
  constructor(message?: string, options?: { errorCode?: SmartErrorCode }) {
    const errCode =
      options?.errorCode !== undefined
        ? ` (error_code=${SmartErrorCode[options.errorCode]})`
        : "";
...
export class RetryableError extends DeviceError {
  constructor(message?: string, options?: { errorCode?: SmartErrorCode }) {
    super(message, options);
...
export const SMART_RETRYABLE_ERRORS: readonly SmartErrorCode[] = [
...
export const SMART_AUTHENTICATION_ERRORS: readonly SmartErrorCode[] = [
